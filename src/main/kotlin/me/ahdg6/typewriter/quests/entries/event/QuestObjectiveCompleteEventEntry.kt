...
@Entry("on_quest_objective_complete", "When a player starts a Quest.", Colors.YELLOW, Icons.BOOK)
/**
 ...
 */
class QuestObjectiveCompleteEventEntry (
...
@EntryListener(QuestObjectiveCompleteEventEntry::class)
fun QuestObjectiveCompleteEvent(event: QuestObjectiveCompleteEvent, query: Query<QuestObjectiveCompleteEventEntry>) {
